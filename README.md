...
<pre> 💭 이번 프로젝트를 하면서 잘 와닿지 않았던 이론적인 개념들을 이해할 수 있게 되었어요! 이게 이렇게 쓰이는 거구나, 이런 원리구나 하는 것들을 깨달았습니다 ㅎㅎ 또 프론트엔드 기술 뿐만 아니라, 프로젝트의 전반적인 흐름과 진행 방식을 배울 수 있었고, 특히 깃^^에 대해 많이 알아갈 수 있었던 것 같습니다 ㅋㅋㅠㅠ 많이 부족한 제가 열정 가득한 좋은 팀원 분들을 만나서 저도 함께 더 열심히 하게 되고, 도움도 많이 받고.. 질문도 많이 하고… 또 나름(?) 뿌듯한 결과물을 내게 되어 너무 감사한 마음이에요 🥹 모든 점에서 너무나도 유익하고 소중한 시간이었습니다 감사합니다 ♥️ </pre>
